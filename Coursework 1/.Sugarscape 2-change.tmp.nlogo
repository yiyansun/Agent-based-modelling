...
to update-mean-sugar
  ...
  ifelse (count turtles with [metabolism = 4] >= 2)
  [
  ...
  [
    ;; set all metrics to 0 if no agents with himtb remaining
    set mean-himtb 0
    set median-himtb 0
    set sd-himtb 0
  ]
...
"" ""
PENS
"lorenz" 1.5 0 -2674135 true "" "plot-pen-reset\nset-plot-pen-interval 100 / count turtles\nplot 0\nforeach lorenz-points plot"
"equal" 1.0 0 -16777216 true "" "plot-pen-down\nplotxy 0 0\nplotxy 100 0\nplotxy 100 100\nplot-pen-up"
...
"" ""
PENS
"default" 1.0 0 -14070903 true "" "plot gini-index"
...
@#$#@#$#@
<experiments>
  <experiment name="test-wealth-dist-by-endowment" repetitions="2" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="300"/>
  ...
  <experiment name="mean-sugar-by-max-endowment-1000" repetitions="2" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="500"/>
    <metric>mean-sugar</metric>
    ...
    <steppedValueSet variable="maximum-sugar-endowment" first="100" step="10" last="1000"/>
    <enumeratedValueSet variable="minimum-sugar-endowment">
      <value value="20"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="visualization">
  ...
  <experiment name="gini-by-max-endowment-1000" repetitions="2" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="500"/>
    <metric>mean-sugar</metric>
  ...
  <experiment name="pop-endowment1" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="500"/>
    <metric>count turtles</metric>
    ...
    <metric>starve-count</metric>
    <metric>age-death-count</metric>
    <steppedValueSet variable="maximum-sugar-endowment" first="25" step="5" last="50"/>
    <steppedValueSet variable="minimum-sugar-endowment" first="0" step="5" last="25"/>
    <steppedValueSet variable="initial-population" first="100" step="20" last="1000"/>
    <enumeratedValueSet variable="visualization">
      <value value="&quot;color-agents-by-vision&quot;"/>
    </enumeratedValueSet>
  </experiment>
  <experiment name="exp1-2" repetitions="2" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
  ...
  <experiment name="exp2-2" repetitions="2" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="1000"/>
    <metric>gini-index</metric>
  ...
  <experiment name="exp3-2" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <steppedValueSet variable="maximum-sugar-endowment" first="20" step="5" last="50"/>
