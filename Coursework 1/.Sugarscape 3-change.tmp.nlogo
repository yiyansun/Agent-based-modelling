...
<experiments>
  ...
  <experiment name="test-wealth-dist-by-vision" repetitions="3" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="300"/>
  ...
  <experiment name="mean-sugar-by-max-endowment" repetitions="2" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="300"/>
    <metric>mean-sugar</metric>
