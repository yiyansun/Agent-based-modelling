...
"" ""
PENS
"Immediate Pattern" 1.0 0 -16777216 true "" "plotxy ticks growth"
...
@#$#@#$#@
<experiments>
  <experiment name="Carrying Capacity(Final Pop)" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="30"/>
