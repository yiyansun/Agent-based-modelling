...
to turtle-setup ;; turtle procedure
  ...
  set m2v metabolism2vision metabolism vision
...
;; To report survivor time for each turtles
to-report metabolism2vision [m v]
  report m / v
end

;; To report growth of population
;; growth =  (currentpop - initialpop) / avg_pop
;; avg_pop = (currentpop + initialpop) / 2
to-report calculate-growth

  let currentTurtles (count turtles)
  report (currentTurtles - initial-population) / initial-population * 100
end
...
"" ""
PENS
"default" 1.0 1 -16777216 true "" "set-histogram-num-bars 10\nset-plot-x-range 0 (max [psugar] of patches + 1)\nset-plot-pen-interval (max [psugar] of patches + 1) / 10\nhistogram [psugar] of patches"
...
"" ""
PENS
"default" 1.0 1 -16777216 true "" "set-histogram-num-bars 10\nset-plot-x-range 0 (max [m2v] of turtles + 1)\nset-plot-pen-interval (max [m2v] of turtles + 1) / 10\nhistogram [m2v] of turtles"
...
"" ""
PENS
"constant pattern" 1.0 0 -4399183 true "" "plotxy ticks growth"
...
@#$#@#$#@
<experiments>
  <experiment name="Carrying Capacity(Final Pop)" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="800"/>
    <metric>count turtles</metric>
    <steppedValueSet variable="initial-population" first="100" step="10" last="1000"/>
  </experiment>
  <experiment name="Growth Change" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="250"/>
