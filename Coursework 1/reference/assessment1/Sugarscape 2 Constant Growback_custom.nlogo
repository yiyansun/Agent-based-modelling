...
"" ""
PENS
"default" 1.0 0 -13791810 true "" "plot (gini-index-reserve / count turtles) * 2"
...
@#$#@#$#@
<experiments>
  <experiment name="test-wealth-dist-by-endowment" repetitions="30" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="500"/>
  ...
  <experiment name="mean-sugar-by-max-endowment-1000" repetitions="10" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="500"/>
    <metric>mean-sugar</metric>
